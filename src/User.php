...
class User
{
    ...
    public static function getUsernameByID($conn, $userID)
    {
    ...
    public static function checkUsernameIfUnique($conn, $userID, $newName)
    {
    ...
    public static function checkEmailIfUnique($conn, $userID, $newEmail)
    {
    ...
    public static function getUserEmailByID($conn, $userID)
    {
    ...
    public static function getIdByUserName($conn, $username)
    {
    ...
    public static function getIdByUserEmail($conn, $email)
    {
    ...
    public static function getPasswordHashByEmail($conn, $email)
    {
